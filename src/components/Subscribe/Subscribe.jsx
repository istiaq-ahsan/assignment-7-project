    ...
    return (
        ...
        <div className="w-3/4 mx-auto border p-4 rounded-xl bg-transparent">
            <div className='front-box flex flex-col text-center space-y-10  mx-auto '>
                <h1 className='text-3xl mt-16 font-bold text-black'>Subscribe to our Newsletter</h1>
                <h3 className='text-2xl font-medium text-black'>Get the latest updates and news in your inbox !</h3>
